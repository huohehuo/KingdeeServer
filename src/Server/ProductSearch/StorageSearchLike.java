 ...
 */
@WebServlet(urlPatterns = "/StorageSearchLike")
public class StorageSearchLike extends HttpServlet {
        ...
        if (parameter != null) {
            try {
                ...
                SQL = "select t1.FItemID,t1.FEmpID,t1.FName,t1.FNumber,t1.FTypeID,t1.FSPGroupID," +
                        ...
                        " t1 left join t_Item t2 on t1.FItemID=t2.FItemID WHERE t2.FItemClassID=5 AND t2.FDetail=1  AND (((FTypeID not in (501,502,503)) and FTypeID <> 504)) AND t2.FDeleteD=0  and (t1.FNumber like '%"+parameter+"%' or t1.FItemID like '%"+parameter+"%' or t1.FName like '%"+parameter+"%') order by t1.FNumber";//专业版
