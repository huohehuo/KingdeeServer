        ...
        if (parameter != null && !parameter.equals("")) {
            try {
                ...
                if (version.contains("5001") && !version.equals("500116") && !version.equals("500115") ) {
                    SQL = "select t1.FBarcode,isnull(t3.FQty,0) as FINNUM,t2.FIsSnManage,t2.FName,t1.FTypeID,t1.FItemID,t2.FISKFPeriod,convert(INT,t2.FKFPeriod) as FKFPeriod,t1.FItemID,t1.FBarCode,t2.FNumber,'' as FUnitID,t2.FModel,t2.FUnitGroupID,t2.FDefaultLoc,t2.FBatchManager ,isnull(t2.FSalePrice,0) as FSalePrice,t2.FSPID from t_Barcode t1 left join t_ICItem t2 on t1.FItemID=t2.FItemID left join (select SUM(FQty) as FQty,FItemID from ICInventory group by FItemID) t3 on t2.FItemID =t3.FItemID where t1.FBarcode = " + parameter;//旗舰版
                } else {
