...
FPOSName,FWorkShiftId,FLSSrcInterID,FManageType,FSettleDate,FReceiver,FConsignee)
...
FSepcialSaleId,FSecInvoiceQty,FAuxQtyInvoice,FQtyInvoice,FClientEntryID,FPlanMode,FMTONo,FClientOrderNo )
 VALUES (@FInterID,@FEntryID,'0','','',@FItemID,'',0,@FBatchNo,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,0,0,@FAuxPlanPrice,@FPlanAmount,
