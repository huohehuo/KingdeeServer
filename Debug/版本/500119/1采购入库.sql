...
VALUES (@FInterID,@FBillNo,'0',1,0,0,@IsExist,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FPOStyle,Null,Null,Null,Null,Null,Null,0,'',0,@FSelTranType,0,@FExplanation,@FDeptID,@FManagerID,@FEmpID,@FCussentAcctID,0,@FSettleDate,0,0)
