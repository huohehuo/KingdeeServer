...
declare @FEntryID varchar(20),       --明细序号
 ...
 FPeriodDate,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,
 ...
 FItemSuite)
  ...
  @Fauxprice,@Famount,'',Null,0,Null,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,0,0,0,14036,'','','','')
end
