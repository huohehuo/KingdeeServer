...
SELECT @FInterID,@FEntryID,'0','','',@FItemID,0,@FQty,@FUnitID,@FAuxQty,0,0,@Fauxprice,@FAuxTaxPrice,@FAmount,@FTaxRate,@FAuxPriceDiscount,@FDescount,@FCess,@FTaxAmount,@FAllAmount,@FDat,'','',0,0,0,'',0,0,0,0,14036,'','',Null,'',0,Null,0
end
