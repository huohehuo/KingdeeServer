...
FManagerID,FEmpID,FManageType,FPrintCount) 
SELECT @FInterID,@FBillNo,'0',29,0,0,@value,@FROB,0,@Fdate,@FDeptID,'',@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FSupplyID,@FBillTypeID,Null,Null,Null,Null,Null,Null,0,0,'',@FSelTranType,0,@FManagerID,@FEmpID,0,0
...
FPlanAmount,Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,FPeriodDate,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,
FSourceEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FPlanMode,FMTONo) 
 SELECT @FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,@FQty,@FUnitID,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,@Fauxprice,@Famount,'',Null,0,Null,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,14036,''
end
