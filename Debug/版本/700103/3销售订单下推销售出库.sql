...
FConsignee) SELECT @FInterID,@FBillNo,'0',21,0,0,@value,1,0,@Fdate,@FSupplyID,@FSaleStyle,@FCheckDate,@FFManagerID,
@FSManagerID,@FBillerID,Null,Null,Null,Null,Null,'',Null,0,0,12530,0,81,0,'',@FExplanation,@FDeptID,@FEmpID,
...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FSepcialSaleId,FPlanMode,FMTONo,FClientOrderNo,FClientEntryID)
  ...
  @FSourceInterId,@FSourceEntryID,0,0,@FQtyMust,0,14036,'','','0'
