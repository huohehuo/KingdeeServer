...
declare @FEntryID varchar(20),       --明细序号
 ...
 FAmtRef,Fnote,FKFDate,FKFPeriod,FPeriodDate,FSCStockID,FSCSPID,FDCStockID,FDCSPID,FSNListID,
 FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FICMOBillNo,FICMOInterID,FPPBomEntryID,FOrderBillNo,
 FOrderInterID,FOrderEntryID,FPlanMode,FMTONo,FContractBillNO,FContractEntryID,FContractInterID,
 ...
 0,0,0,'',Null,0,Null,@FSCStockID,@FSCSPID,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,'',0,0,14036,'','',0,0,'','' 
end
