...
FExplanation,FDeptID,FManagerID,FEmpID,FCussentAcctID,FManageType,FSettleDate,FPOMode,FPrintCount) 
SELECT @FInterID,@FBillNo,'0',1,0,0,@value,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FPOStyle,Null,Null,Null,Null,Null,Null,'',0,0,@FSelTranType,0,@FExplanation,@FDeptID,@FManagerID,@FEmpID,0,0,@FSettleDate,0,0
