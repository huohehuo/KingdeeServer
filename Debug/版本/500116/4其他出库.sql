...
FMultiCheckDate2,FMultiCheckDate3,FMultiCheckDate4,FMultiCheckDate5,FMultiCheckDate6,FPOOrdBillNo,FRelateBrID,FSelTranType,
FPrintCount,FBrID,FManagerID,FEmpID,FUse,FManageType,FOrderAffirm) 
VALUES (@FInterID,@FBillNo,'0',29,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,
@FDeptID,@FBillTypeID,Null,Null,Null,Null,Null,Null,'',0,@FSelTranType,0,0,@FManagerID,@FEmpID,@FUse,0,Null)
