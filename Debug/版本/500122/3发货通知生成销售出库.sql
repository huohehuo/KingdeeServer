...
INSERT INTO ICStockBill(FInterID,FBillNo,FBrNo,FTranType,FCancellation,FStatus,FDiscountType,FUpStockWhenSave,FVchInterID,
FROB,FHookStatus,Fdate,FSupplyID,FSaleStyle,FCheckDate,FFManagerID,FSManagerID,FBillerID,FMultiCheckDate1,FMultiCheckDate2,
FMultiCheckDate3,FMultiCheckDate4,FMultiCheckDate5,FPOOrdBillNo,FMultiCheckDate6,FRelateBrID,FOrgBillInterID,FMarketingStyle,
FSelTranType,FPrintCount,FBrID,FFetchAdd,FExplanation,FDeptID,FEmpID,FManagerID,FVIPCardID,FVIPScore,FHolisticDiscountRate,
FPOSName,FWorkShiftId,FLSSrcInterID,FManageType,FSettleDate,FSellerMessage,FTelephone,FMobile,FReceiver,FDeliveryAddress,
FDeliveryCity,FDeliveryDistrict,FDeliveryProvince,FBuyerMessage,FBuyerNick,FConsignee) 
VALUES (@FInterID,@FBillNo,'0',21,0,0,0,@value,0,1,0,@Fdate,@FSupplyID,@FSaleStyle,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,
Null,Null,Null,Null,Null,'',Null,0,0,12530,83,0,0,@FFetchAdd,@FExplanation,@FDeptID,@FEmpID,@FManagerID,0,0,0,'',0,0,0,
@FSettleDate,'','','','','','','','','','',0)
...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 INSERT INTO  ICStockBillEntry (FInterID,FEntryID,FBrNo,FMapNumber,FMapName,FItemID,FOLOrderBillNo,FAuxPropID,FBatchNo,FQty,FUnitID,
 FAuxQtyMust,Fauxqty,FSecCoefficient,FSecQty,FAuxPlanPrice,FPlanAmount,Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,FPeriodDate,
 FDCStockID,FDCSPID,FConsignPrice,FDiscountRate,FUniDiscount,FDiscountAmount,FConsignAmount,FOrgBillEntryID,FSNListID,
 FBuyerFreight,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FContractBillNo,FContractInterID,
 FContractEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FAllHookQTY,FCurrentHookQTY,FQtyMust,FSepcialSaleId,
 FSecInvoiceQty,FAuxQtyInvoice,FQtyInvoice,FPlanMode,FMTONo,FClientEntryID,FClientOrderNo,FBarCode_EntrySelfA0156)
  VALUES (@FInterID,@FEntryID,'0','','',@FItemID,'',0,@FBatchNo,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,0,0,'',
  Null,0,Null,@FDCStockID,@FDCSPID,@FConsignPrice,0,0,0,@FConsignAmount,0,0,0,@FSourceBillNo,83,@FSourceInterId,@FSourceEntryID,'',0,0,@FOrderBillNo,@FOrderInterID,@FOrderEntryID,0,0,@FQtyMust,0,0,0,0,14036,'','','','') 
