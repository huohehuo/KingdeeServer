...
FHookStatus,Fdate,FSupplyID,FCheckDate,FFManagerID,FSManagerID,FBillerID,FDeptID,FBillTypeID,FMultiCheckDate1,
FMultiCheckDate2,FMultiCheckDate3,FMultiCheckDate4,FMultiCheckDate5,FMultiCheckDate6,FPOOrdBillNo,FRelateBrID,
FSelTranType,FPrintCount,FBrID,FManagerID,FEmpID,FUse,FManageType,FOrderAffirm) 
VALUES (@FInterID,@FBillNo,'0',29,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FDeptID,@FBillTypeID,Null,Null,Null,Null,Null,Null,'',0,@FSelTranType,0,0,@FManagerID,@FEmpID,@FUse,0,Null)
...
FOrderBillNo,FOrderInterID,FOrderEntryID,FPlanMode,FMTONo,FCostPercentage) 
VALUES (@FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,0,@FQty,@FUnitID,0,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,@Fauxprice,@Famount,'',Null,0,Null,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,14036,'',0) 
end
