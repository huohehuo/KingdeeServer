...
FSelTranType,FPrintCount,FBrID,FManagerID,FEmpID,FExplanation,FManageType,FOrderAffirm) 
VALUES (@FInterID,@FBillNo,'0',10,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FDeptID,@FBillTypeID,Null,Null,Null,Null,Null,Null,'',0,@FSelTranType,0,0,@FManagerID,@FEmpID,@FExplanation,0,'0')
