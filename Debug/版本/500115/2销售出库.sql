...
FPOSName,FWorkShiftId,FLSSrcInterID,FManageType,FSettleDate,
FConsignee) VALUES (@FInterID,@FBillNo,'0',21,0,0,@value,0,@FROB,0,
@Fdate,@FSupplyID,@FSaleStyle,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,Null,Null,Null,Null,Null,'',Null,0,
0,12530,@FSelTranType,0,0,@FFetchAdd,@FExplanation,@FDeptID,@FEmpID,@FManagerID,0,0,0,'',0,0,0,@FSettleDate,0)
...
declare @FEntryID varchar(20),       --明细序号
   ...
   FAuxPropID,FBatchNo,FQty,FUnitID,FAuxQtyMust,Fauxqty,
    ...
    FQtyMust,FSepcialSaleId,FSecInvoiceQty,FAuxQtyInvoice,FQtyInvoice,FPlanMode,FMTONo,FClientEntryID,FClientOrderNo)
     VALUES (@FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,@FQty,@FUnitID,0,@Fauxqty,0,0,@FAuxPlanPrice,@FPlanAmount,@Fauxprice,@Famount,'',
