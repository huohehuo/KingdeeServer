...
set @FExplanation='' --备注
 ...
 FSettleDate,FSellerMessage,FTelephone,FMobile,FReceiver,FDeliveryAddress,FDeliveryCity,FDeliveryDistrict,
 FDeliveryProvince,FBuyerMessage,FBuyerNick,FConsignee) 
 VALUES (@FInterID,@FBillNo,'0',21,0,0,0,@value,0,1,0,@Fdate,@FSupplyID,@FSaleStyle,Null,@FFManagerID,@FSManagerID,@FBillerID,Null,Null,Null,Null,Null,'',Null,0,0,12530,81,0,0,'',@FExplanation,@FDeptID,@FManagerID,@FEmpID,0,0,0,'',0,0,0,@FSettleDate,'','','','','','','','','','',0)
...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FAuxPlanPrice,FPlanAmount,Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,FPeriodDate,FDCStockID,FDCSPID,FConsignPrice,FDiscountRate,FUniDiscount,FDiscountAmount,
 FConsignAmount,FOrgBillEntryID,FSNListID,FBuyerFreight,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FContractBillNo,FContractInterID,
 FContractEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FAllHookQTY,FCurrentHookQTY,FQtyMust,FSepcialSaleId,FSecInvoiceQty,FAuxQtyInvoice,FQtyInvoice,
 FPlanMode,FMTONo,FClientEntryID,FClientOrderNo,FBarCode_EntrySelfA0156)
  VALUES (@FInterID,@FEntryID,'0','','',@FItemID,'',0,@FBatchNo,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,0,0,'',Null,0,Null,@FDCStockID,@FDCSPID,@FConsignPrice,0,0,0,@FConsignAmount,0,0,0,@FSourceBillNo,81,@FSourceInterId,@FSourceEntryID,'',0,0,@FSourceBillNo,@FSourceInterId,@FSourceEntryID,0,0,@FQtyMust,0,0,0,0,14036,'','0','','')  
