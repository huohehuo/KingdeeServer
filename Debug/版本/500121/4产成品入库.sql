...
FHookStatus,Fdate,FDeptID,FCheckDate,FFManagerID,FSManagerID,FBillerID,FMultiCheckDate1,FMultiCheckDate2,FMultiCheckDate3,
FMultiCheckDate4,FMultiCheckDate5,FMultiCheckDate6,FSelTranType,FManageType,FPrintCount) 
VALUES (@FInterID,@FBillNo,'0',2,0,0,@value,0,@FROB,0,@Fdate,@FDeptID,@FManagerID,@FFManagerID,@FSManagerID,@FBillerID,Null,Null,Null,Null,Null,Null,@FSelTranType,0,0)
...
declare @FEntryID varchar(20),       --明细序号
 ...
 INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FAuxPropID,FBatchNo,FQtyMust,FQty,FUnitID,FAuxQtyMust,Fauxqty,FSecCoefficient,FSecQty,FAuxPlanPrice,FPlanAmount,
 Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,FPeriodDate,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FICMOBillNo,
 FICMOInterID,FPPBomEntryID,FPlanMode,FMTONo,FPrice)
