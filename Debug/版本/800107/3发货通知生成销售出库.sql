...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 @FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,0,0,'',Null,0,Null,0,0,@FDCStockID,@FDCSPID,@FConsignPrice,0,
  @FConsignAmount,0,0,0,@FSourceBillNo,83,@FSourceInterId,@FSourceEntryID,'',0,0,@FOrderBillNo,@FOrderInterID,@FOrderEntryID,0,0,@FQtyMust,0,14036,'','','','0',1058,@FSEOutBillNo,@FSEOutEntryID,@FSEOutInterID
end
