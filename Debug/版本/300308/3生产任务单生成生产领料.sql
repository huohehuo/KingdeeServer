...
EXEC p_UpdateBillRelateData 24,@FInterID --,'ICStockBill','ICStockBillEntry' 
 declare @FHeadSelfB0422 varchar(128),  --订单号
         ...
         @FBillSource int,
         @FMOQty decimal(20,5) 
 	select @FMOItemID=FItemID,@FMOUnitID=FUnitID,@FMOAuxQty=FAuxQty,@FBillSource=FBillSource from ICMO where FInterID=@FSourceInterId
 	set @FMOBaseUnitID=@FMOUnitID
 	set @FMOQty=@FMOAuxQty
 update ICStockBill set FBillSource=@FBillSource, FMOItemID=@FMOItemID,FMOUnitID=@FMOUnitID,FMOAuxQty=@FMOAuxQty,FMOBaseUnitID=@FMOBaseUnitID,FMOQty=@FMOQty where FInterID=@FInterID
