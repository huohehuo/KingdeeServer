if (exists (select * from sys.objects where name = 'proc_OutsourceOut'))
    drop proc proc_OutsourceOut
go
create proc proc_OutsourceOut
(
...
INSERT INTO ICStockBill(FInterID,FBillNo,FBrNo,FTranType,FCancellation,FStatus,FUpStockWhenSave,FROB,FHookStatus,Fdate,FSupplyID,
FPurposeID,Fnote,FCheckDate,FSManagerID,FFManagerID,FBillerID,FMultiCheckDate1,FMultiCheckDate2,FMultiCheckDate3,
FMultiCheckDate4,FMultiCheckDate5,FMultiCheckDate6,FVchInterID,FSelTranType,FBackFlushed,FManageType,FRelateBrID,
FPOOrdBillNo,FBrID,FPrintCount) 
VALUES (@FInterID,@FBillNo,'0',28,0,0,@value,@FROB,0,@Fdate,@FSupplyID,@FPurposeID,@FExplanation,@FCheckDate,@FSManagerID,
@FFManagerID,@FBillerID,Null,Null,Null,Null,Null,Null,0,1007105,0,0,0,'',0,0)
...
declare @FEntryID varchar(20),       --明细序号
 ...
 INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FMapNumber,FMapName,FItemID,FAuxPropID,FBatchNo,FQty,FQtyMust,
 FUnitID,FAuxQtyMust,Fauxqty,FSecCoefficient,FSecQty,FAuxPlanPrice,FPlanAmount,Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,
 FPeriodDate,FIsVMI,FEntrySupply,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,
 FOrderBillNo,FOrderInterID,FOrderEntryID,FICMOInterID,FPPBomEntryID,FInStockID,FPlanMode,FMTONo,FPositionNo,FItemSize,
 FItemSuite)
  VALUES (@FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,@FQty,0,@FUnitID,0,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,
  @Fauxprice,@Famount,'',Null,0,Null,0,0,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,0,0,0,14036,'','','','')
end
