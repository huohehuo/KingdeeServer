...
VALUES (@FInterID,@FBillNo,'0',21,0,0,@value,0,1,0,@Fdate,@FSupplyID,@FSaleStyle,@FCheckDate,@FFManagerID,@FDeptID,@FBillerID,0,
81,@FFetchAdd,@FExplanation,@FManagerID,@FEmpID,@FSManagerID,Null,0,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,
0,12530,0,0,0,'',0)  
...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FDCStockID,FAuxPropID,FBatchNo,FQty,FUnitID,
FAuxQtyMust,Fauxqty,Fauxprice,Famount,Fnote,FSecCoefficient,FKFDate,FKFPeriod,FSecQty,FAuxPlanPrice,FPeriodDate,FConsignPrice,
FPlanAmount,FDiscountRate,FDiscountAmount,FConsignAmount,FOrgBillEntryID,FSourceBillNo,FSourceTranType,FSourceInterId,
FSourceEntryID,FOrderBillNo,FDVStockID,FOrderInterID,FDCSPID,FOrderEntryID,FQtyMust,FAuxQtyInvoice,FQtyInvoice,FSNListID,
FContractBillNo,FContractInterID,FContractEntryID,FAllHookQTY,FCurrentHookQTY,FSepcialSaleId) 
VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,0,0,'',0,
Null,0,0,@FAuxPlanPrice,Null,@FConsignPrice,@FPlanAmount,0,0,@FConsignAmount,0,@FSourceBillNo,81,@FSourceInterId,
