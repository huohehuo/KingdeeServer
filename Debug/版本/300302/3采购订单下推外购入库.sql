...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FContractEntryID,FAllHookQTY,FAllHookAmount,FCurrentHookQTY,FCurrentHookAmount)
  VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,@FQtyMust,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,
  @Fauxprice,@Famount,'',Null,0,0,0,@FAuxPlanPrice,Null,0,@FPlanAmount,@FSourceBillNo,71,@FSourceInterId,@FSourceEntryID,
  @FSourceBillNo,@FSourceInterId,@FSourceEntryID,0,0,0,@FDCSPID,0,'',0,0,0,0,0,0)
