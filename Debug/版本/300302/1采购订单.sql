...
INSERT INTO POOrderEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FAuxPropID,FQty,FUnitID,FAuxQty,Fauxprice,
FAuxTaxPrice,FAmount,FTaxRate,FSecCoefficient,FAuxPriceDiscount,FSecQty,FDescount,FCess,FTaxAmount,FAllAmount,Fdate,Fnote,
FAuxQtyInvoice,FQtyInvoice,FMrpLockFlag,FSourceBillNo,FSourceTranType,FSourceInterId,
FSourceEntryID,FContractBillNo,FContractInterID,FContractEntryID) 
VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',0,@FQty,@FUnitID,@FAuxQty,@Fauxprice,@FAuxTaxPrice,@FAmount,@FTaxRate,0,
@FAuxPriceDiscount,0,0,@FCess,@FTaxAmount,@FAllAmount,@Fdat,'',0,0,0,'',0,0,0,'',0,0) 
end
