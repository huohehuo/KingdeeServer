...
FConsignee) SELECT @FInterID,@FBillNo,'0',21,0,0,@value,1,0,@Fdate,@FSupplyID,@FSaleStyle,Null,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,0,Null,Null,Null,Null,Null,'',Null,0,0,12530,0,83,0,'','',@FExplanation,@FDeptID,@FEmpID,@FManagerID,0,0,'',0,'',0,0,0,0,@FSettleDate,0
