...
FHookStatus,Fdate,FDeptID,FCheckDate,FFManagerID,FSManagerID,FBillerID,FSelTranType,FExplanation,FMultiCheckLevel1,
FMultiCheckDate1,FMultiCheckLevel2,FMultiCheckDate2,FMultiCheckLevel3,FMultiCheckDate3,FMultiCheckLevel4,FMultiCheckDate4,
FMultiCheckLevel5,FMultiCheckDate5,FMultiCheckLevel6,FMultiCheckDate6) 
...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FDCStockID,FAuxPropID,FBatchNo,FQtyMust,FQty,FUnitID,
FAuxQtyMust,Fauxqty,Fauxprice,Famount,FSecCoefficient,Fnote,FSecQty,FKFDate,FKFPeriod,FAuxPlanPrice,FPlanAmount,
FPeriodDate,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FDCSPID,FSNListID,FCustItemNo,FCustItemName,
FMOBillNo,FMOInterID,FPPBomEntryID,FOrderBillNo,FOrderEntryID,FOrderInterID)
 VALUES (@FInterID,@FEntryID,'0',@FItemID,@FDCStockID,0,@FBatchNo,0,@FQty,@FUnitID,0,@Fauxqty,@Fauxprice,@Famount,
 0,'',0,Null,0,@FAuxPlanPrice,@FPlanAmount,Null,'',0,0,0,@FDCSPID,0,'','','',0,0,'',0,0) 
end
