...
FHookStatus,Fdate,FSupplyID,FCheckDate,FSManagerID,FManagerID,FCustID,FBillerID,FDeptID,FSelTranType,FFManagerID,FEmpID,
FExplanation,FBillTypeID,FMultiCheckLevel1,FMultiCheckDate1,FMultiCheckLevel2,FMultiCheckDate2,FMultiCheckLevel3,
...
FRelateBrID,FBrID) 
VALUES (@FInterID,@FBillNo,'0',10,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FSManagerID,@FManagerID,@FCustID,@FBillerID,@FDeptID,0,@FFManagerID,@FEmpID,@FExplanation,0,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,0,0)
...
FOrderEntryID,FDCSPID,FSNListID) VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,0,@FQty,
@FUnitID,0,@Fauxqty,@Fauxprice,@Famount,'',Null,0,0,Null,0,'',0,0,0,0,0,'',0,0,@FDCSPID,0) 
end
