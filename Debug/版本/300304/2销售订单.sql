...
INSERT INTO SEOrderEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FAuxPropID,FCustItemNo,FCustItemName,FQty,FUnitID,Fauxqty,Fauxprice,FAuxTaxPrice,Famount,FCess,FSecCoefficient,FTaxRate,FUniDiscount,FSecQty,FTaxAmount,FAuxPriceDiscount,FTaxAmt,FAllAmount,FTranLeadTime,FInForecast,FDate,Fnote,FPurchasePlanBillNo,FAuxQtyInvoice,FQtyInvoice,FCommitInstall,FAuxCommitInstall,FAllStdAmount,FMrpLockFlag,FBomInterID,FCostObjectID,FAdviceConsignDate,FATPDeduct,FLockFlag,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FContractBillNo,FOrderCommitQty,FContractInterID,FContractEntryID) VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',0,'','',@FQty,@FUnitID,@Fauxqty,@Fauxprice,@FAuxTaxPrice,@Famount,@FCess,0,0,0,0,@FTaxAmount,@FAuxPriceDiscount,@FTaxAmt,@FAllAmount,'',0,@FDat,'','',0,0,0,0,@FAllAmount,0,0,'0',@FAdviceConsignDate,0,0,'',0,0,0,'',0,0,0) 
end
