...
declare @FEntryID varchar(20),       --明细序号
    ...
    FOrderBillNo,FOrderInterID,FOrderEntryID,FAllHookQTY,FCurrentHookQTY,FQtyMust,FSepcialSaleId,FSecInvoiceQty,FAuxQtyInvoice,FQtyInvoice,FPlanMode,FMTONo,
    FClientEntryID,FClientOrderNo,FBarCode_EntrySelfA0156) 
