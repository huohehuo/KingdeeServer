...
FOrderBillNo,FOrderInterID,FOrderEntryID,FPlanMode,FMTONo,FCostPercentage,FDeliveryNoticeFID,FDeliveryNoticeEntryID,FChkPassItem) 
 SELECT @FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,0,@FQty,@FUnitID,0,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,@Fauxprice,@Famount,'',Null,0,Null,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,14036,'',0,0,0,1058 
end
