...
declare @FEntryID varchar(20),       --明细序号
 ...
 INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FAuxPropID,FBatchNo,FQty,FDefaultBaseQty,FRealStockBaseQty,FUnitID,FDefaultQty,FRealStockQty,Fauxqty,FSecCoefficient,FSecQty,FAuxPlanPrice,FPlanAmount,Fauxprice,Famount,FAuxPriceRef,FAmtRef,Fnote,FKFDate,FKFPeriod,FPeriodDate,FIsVMI,FEntrySupply,FSCStockID,FSCSPID,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FICMOBillNo,FICMOInterID,FPPBomEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FPlanMode,FMTONo,FChkPassItem,FContractBillNO,FContractEntryID,FContractInterID,FLockFlag,FClientEntryID,FClientOrderNo)  SELECT @FInterID,@FEntryID,'0',@FItemID,0,@FBatchNo,@FQty,0,0,@FUnitID,0,0,@Fauxqty,0,0,@FAuxPlanPrice,@FPlanAmount,0,0,0,0,'',Null,0,Null,0,0,@FSCStockID,@FSCSPID,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,'',0,0,14036,'',1058,'',0,0,0,'','' 
end
