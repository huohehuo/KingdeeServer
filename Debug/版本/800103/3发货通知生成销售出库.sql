...
FPrintCount,FSelTranType,FBrID,FFetchAdd,FConfirmMem,FExplanation,FDeptID,FEmpID,FManagerID,FVIPCardID,FVIPScore,FReceiver,
FHolisticDiscountRate,FPOSName,FWorkShiftId,FLSSrcInterID,FManageType,FPayCondition,FSettleDate,FConsignee) 
SELECT @FInterID,@FBillNo,'0',21,0,0,@value,1,0,@Fdate,@FSupplyID,@FSaleStyle,Null,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,0,Null,Null,Null,Null,Null,'',Null,0,0,12530,0,83,0,'','',@FExplanation,@FDeptID,@FEmpID,@FManagerID,0,0,'',0,'',0,0,0,0,@FSettleDate,0
...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FSEOutBillNo,FSEOutEntryID,FSEOutInterID)
  ...
  @FConsignAmount,0,0,0,@FSourceBillNo,83,@FSourceInterId,@FSourceEntryID,'',0,0,@FOrderBillNo,@FOrderInterID,@FOrderEntryID,0,0,@FQtyMust,0,14036,'','','','0',1058,@FSourceBillNo,@FSourceEntryID,@FSourceInterId   
end
