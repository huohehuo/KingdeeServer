...
FConsignee) SELECT @FInterID,@FBillNo,'0',21,0,0,@value,1,0,@Fdate,@FSupplyID,@FSaleStyle,Null,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,0,Null,Null,Null,Null,Null,'',Null,0,0,12530,0,81,0,'','',@FExplanation,@FDeptID,@FEmpID,@FManagerID,0,0,'',0,'',0,0,0,0,@FSettleDate,0
...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FClientEntryID,FChkPassItem,FSEOutBillNo,FSEOutEntryID,FSEOutInterID,FReturnNoticeBillNo,FReturnNoticeEntryID,FReturnNoticeInterID,FProductFileQty)  
 SELECT @FInterID,@FEntryID,'0','','',@FItemID,'',0,@FBatchNo,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,0,0,'',Null,0,Null,0,0,@FDCStockID,@FDCSPID,@FConsignPrice,0,@FConsignAmount,0,0,0,@FSourceBillNo,81,@FSourceInterId,@FSourceEntryID,'',0,0,@FSourceBillNo,@FSourceInterId,@FSourceEntryID,0,0,@FQtyMust,0,14036,'','','','0',1058,'',0,0,'',0,0,0    
