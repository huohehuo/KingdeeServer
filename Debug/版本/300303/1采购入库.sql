...
FHookStatus,Fdate,FSupplyID,FCheckDate,FSManagerID,FBillerID,FPOStyle,FOrgBillInterID,FSelTranType,FExplanation,FManagerID,
FDeptID,FFManagerID,FMultiCheckLevel1,FEmpID,FMultiCheckDate1,FMultiCheckLevel2,FMultiCheckDate2,FMultiCheckLevel3,
...
FRelateBrID,FBrID,FCussentAcctID)
 VALUES (@FInterID,@FBillNo,'0',1,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FSManagerID,@FBillerID,@FPOStyle,0,0,@FExplanation,@FManagerID,@FDeptID,@FFManagerID,Null,@FEmpID,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,0,0,0)
