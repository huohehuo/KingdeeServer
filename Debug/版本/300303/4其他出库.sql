...
select @Fnumber=a.FProjectVal from t_billcoderule a
 ...
 where a.fbilltypeid = '29' and  a.FProjectID=3 order by a.FClassIndex
 --流水号长度
...
---更新流水号
 ...
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '29' and a.FProjectID=3  ---更新单号
...
select @FClassIndex= COUNT(1) from t_billcoderule a
 ...
 left join t_option b on a.fprojectid=b.fprojectid and a.fformatindex=b.fid
 left join t_checkproject c on a.fbilltype = c.fbilltypeid and a.fprojectval = c.ffield
 where a.fbilltypeid = 29 and a.FClassIndex=@Index
 if(@FProjectID='1')
 begin
 --编号前缀    
select @Fprefix=a.FProjectVal from t_billcoderule a
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '29' and  a.FProjectID=1 and a.FClassIndex=@Index order by a.FClassIndex
 ...
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '29' and  a.FProjectID=2 and a.FClassIndex=@Index order by a.FClassIndex
...
FHookStatus,Fdate,FDeptID,Fuse,FCheckDate,FEmpID,FFManagerID,FBillerID,FSupplyID,FSelTranType,FBillTypeID,FMultiCheckLevel1,
FSManagerID,FManagerID,FMultiCheckDate1,FMultiCheckLevel2,FMultiCheckDate2,FMultiCheckLevel3,FMultiCheckDate3,
FMultiCheckLevel4,FMultiCheckDate4,FMultiCheckLevel5,FMultiCheckDate5,FMultiCheckLevel6,FMultiCheckDate6,FRelateBrID,FBrID)
 VALUES (@FInterID,@FBillNo,'0',29,0,0,@value,0,@FROB,0,@Fdate,@FDeptID,@Fuse,@FCheckDate,@FEmpID,@FFManagerID,@FBillerID,@FSupplyID,0,0,Null,@FSManagerID,@FManagerID,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,0,0)
...
FUnitID,Fauxqty,Fauxprice,Famount,Fnote,FKFDate,FSecCoefficient,FKFPeriod,FSecQty,FPeriodDate,FSourceBillNo,FAuxPlanPrice,
FPlanAmount,FSourceTranType,FSourceInterId,FSourceEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FDCSPID,FSNListID) 
VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,@FQty,@FUnitID,@Fauxqty,@Fauxprice,@Famount,'',
Null,0,0,0,Null,'',0,0,0,0,0,'',0,0,@FDCSPID,0) 
end
