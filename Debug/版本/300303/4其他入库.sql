...
--判断是客户还是供应商
declare @ISnull int
select @ISnull=COUNT(*) from t_Supplier where FItemID=@FSupplyID
if(@ISnull>0)
begin
set @FCustID=0 --如果上传的是供应商 客户id为0
end
else
begin
set @FCustID=@FSupplyID --如果<0 说明是客户
set @FSupplyID=0
end
--判断是客户还是供应商
...
select @Fnumber=a.FProjectVal from t_billcoderule a
 ...
 where a.fbilltypeid = '10' and  a.FProjectID=3 order by a.FClassIndex
 --流水号长度
...
---更新流水号
 ...
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '10' and a.FProjectID=3  ---更新单号
...
select @FClassIndex= COUNT(1) from t_billcoderule a
 ...
 left join t_option b on a.fprojectid=b.fprojectid and a.fformatindex=b.fid
 left join t_checkproject c on a.fbilltype = c.fbilltypeid and a.fprojectval = c.ffield
 where a.fbilltypeid = 10 and a.FClassIndex=@Index
 if(@FProjectID='1')
 begin
 --编号前缀    
select @Fprefix=a.FProjectVal from t_billcoderule a
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '10' and  a.FProjectID=1 and a.FClassIndex=@Index order by a.FClassIndex
 ...
 left join t_option e on a.fprojectid=e.fprojectid and a.fformatindex=e.fid
 Left OUter join t_checkproject b on a.fbilltype=b.fbilltypeid and a.fprojectval=b.ffield
 where a.fbilltypeid = '10' and  a.FProjectID=2 and a.FClassIndex=@Index order by a.FClassIndex
...
FHookStatus,Fdate,FSupplyID,FCheckDate,FSManagerID,FManagerID,FCustID,FBillerID,FDeptID,FSelTranType,FFManagerID,
FEmpID,FExplanation,FBillTypeID,FMultiCheckLevel1,FMultiCheckDate1,FMultiCheckLevel2,FMultiCheckDate2,FMultiCheckLevel3,
FMultiCheckDate3,FMultiCheckLevel4,FMultiCheckDate4,FMultiCheckLevel5,FMultiCheckDate5,FMultiCheckLevel6,FMultiCheckDate6,
FRelateBrID,FBrID) VALUES (@FInterID,@FBillNo,'0',10,0,0,@value,0,@FROB,0,@Fdate,@FSupplyID,@FCheckDate,@FSManagerID,@FManagerID,
@FCustID,@FBillerID,@FDeptID,0,@FFManagerID,@FEmpID,@FExplanation,0,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,0,0)
...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FDCStockID,FAuxPropID,FBatchNo,FQtyMust,
FQty,FUnitID,FAuxQtyMust,Fauxqty,Fauxprice,Famount,Fnote,FKFDate,FSecCoefficient,FKFPeriod,FPeriodDate,FSecQty,
FSourceBillNo,FAuxPlanPrice,FPlanAmount,FSourceTranType,FSourceInterId,FSourceEntryID,FOrderBillNo,FOrderInterID,
FOrderEntryID,FDCSPID,FSNListID)
 VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,0,@FQty,@FUnitID,0,@Fauxqty,@Fauxprice,@Famount,'',
 Null,0,0,Null,0,'',0,0,0,0,0,'',0,0,@FDCSPID,0) 
end
