...
FPeriodDate,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FDCSPID,FSNListID,
FMOBillNo,FMOInterID,FPPBomEntryID,FOrderBillNo,FOrderEntryID,FOrderInterID) 
VALUES (@FInterID,@FEntryID,'0',@FItemID,@FDCStockID,0,@FBatchNo,0,@FQty,@FUnitID,0,@Fauxqty,@Fauxprice,@Famount,0,
'',0,Null,0,@FAuxPlanPrice,@FPlanAmount,Null,'',0,0,0,@FDCSPID,0,'',0,0,'',0,0) 
end
