...
FMultiCheckLevel6,FMultiCheckDate6,FRelateBrID,FMarketingStyle,FBrID,FVIPCardID,FVIPScore,FPOSName,FWorkShiftId)
 VALUES (@FInterID,@FBillNo,'0',21,0,0,@value,0,1,0,@Fdate,@FSupplyID,@FSaleStyle,@FCheckDate,@FFManagerID,@FDeptID,@FBillerID,
 0,81,@FFetchAdd,@FExplanation,@FManagerID,@FEmpID,@FSManagerID,Null,0,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,0,12530,0,0,0,'',0)  
...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FDCStockID,FAuxPropID,FBatchNo,FQty,
FUnitID,FAuxQtyMust,Fauxqty,Fauxprice,Famount,Fnote,FSecCoefficient,FKFDate,FKFPeriod,FSecQty,FAuxPlanPrice,FPeriodDate,
FConsignPrice,FPlanAmount,FDiscountRate,FDiscountAmount,FConsignAmount,FOrgBillEntryID,FSourceBillNo,FSourceTranType,
FSourceInterId,FSourceEntryID,FOrderBillNo,FDVStockID,FOrderInterID,FDCSPID,FOrderEntryID,FQtyMust,FAuxQtyInvoice,
FQtyInvoice,FSNListID,FContractBillNo,FContractInterID,FContractEntryID,FAllHookQTY,FCurrentHookQTY,FSepcialSaleId) 
