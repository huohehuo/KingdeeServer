...
declare @FEntryID varchar(20),       --新的明细序号
 ...
 FPPBomEntryID,FPlanMode,FMTONo,FChkPassItem) 
  SELECT @FInterID,@FEntryID,'0',@FDCStockID,@FItemID,0,@FBatchNo,@FQtyMust,@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,0,
  @FSecCoefficient,@FSecQty,0,0,0,'',Null,0,Null,@FDCSPID,0,@FSourceBillNo,85,@FSourceInterId,0,@FSourceBillNo,@FSourceInterId,0,14036,'',1058
