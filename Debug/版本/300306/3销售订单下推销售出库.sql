...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FDCStockID,FAuxPropID,FBatchNo,FCustItemNo,FCustItemName,FQty,FUnitID,FAuxQtyMust,Fauxqty,Fauxprice,Famount,Fnote,FSecCoefficient,FKFDate,FKFPeriod,FSecQty,FAuxPlanPrice,FPeriodDate,FConsignPrice,FPlanAmount,FDiscountRate,FDiscountAmount,FConsignAmount,FOrgBillEntryID,FSourceBillNo,FSourceTranType,FSourceInterId,FSourceEntryID,FOrderBillNo,FDVStockID,FOrderInterID,FDCSPID,FOrderEntryID,FQtyMust,FAuxQtyInvoice,FQtyInvoice,FSNListID,FContractBillNo,FContractInterID,FContractEntryID,FAllHookQTY,FCurrentHookQTY,FSepcialSaleId) VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,'','',@FQty,@FUnitID,@FAuxQtyMust,@Fauxqty,0,0,'',0,Null,0,0,@FAuxPlanPrice,Null,@FConsignPrice,@FPlanAmount,0,0,@FConsignAmount,0,@FSourceBillNo,81,@FSourceInterId,@FSourceEntryID,@FSourceBillNo,0,@FSourceInterId,0,@FSourceEntryID,0,0,0,0,'',0,0,0,0,0) 
end
