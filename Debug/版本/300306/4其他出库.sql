...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FItemID,FMapNumber,FMapName,FDCStockID,FAuxPropID,FBatchNo,FQty,FUnitID,Fauxqty,Fauxprice,Famount,Fnote,FKFDate,FSecCoefficient,FKFPeriod,FSecQty,FPeriodDate,FSourceBillNo,FAuxPlanPrice,FPlanAmount,FSourceTranType,FSourceInterId,FSourceEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FDCSPID,FSNListID) VALUES (@FInterID,@FEntryID,'0',@FItemID,'','',@FDCStockID,0,@FBatchNo,@FQty,@FUnitID,@Fauxqty,@Fauxprice,@Famount,'',Null,0,0,0,Null,'',0,0,0,0,0,'',0,0,0,0) 
end
