...
FMultiCheckDate3,FMultiCheckDate4,FMultiCheckDate5,FMultiCheckDate6,FVchInterID,FRelateBrID,FPOOrdBillNo,FSelTranType,FBrID,
FManagerID,FEmpID,FManageType,FPrintCount,FObjectItem) 
SELECT @FInterID,@FBillNo,'0',29,0,0,@value,@FROB,0,@Fdate,@FDeptID,'',@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FSupplyID,@FBillTypeID,Null,Null,Null,Null,Null,Null,0,0,'',@FSelTranType,0,@FManagerID,@FEmpID,0,0,0
...
INSERT INTO ICStockBillEntry (FInterID,FEntryID,FBrNo,FMapNumber,FMapName,FItemID,FAuxPropID,FBatchNo,FQty,FUnitID,Fauxqty,FSecCoefficient,FSecQty,FAuxPlanPrice,
FPlanAmount,Fauxprice,Famount,Fnote,FKFDate,FKFPeriod,FPeriodDate,FIsVMI,FEntrySupply,FDCStockID,FDCSPID,FSNListID,FSourceBillNo,FSourceTranType,FSourceInterId,
FSourceEntryID,FOrderBillNo,FOrderInterID,FOrderEntryID,FPlanMode,FMTONo,FSEOutBillNo,FSEOutEntryID,FSEOutInterID) 
 SELECT @FInterID,@FEntryID,'0','','',@FItemID,0,@FBatchNo,@FQty,@FUnitID,@Fauxqty,@FSecCoefficient,@FSecQty,@FAuxPlanPrice,@FPlanAmount,@Fauxprice,@Famount,'',Null,0,Null,0,0,@FDCStockID,@FDCSPID,0,'',0,0,0,'',0,0,14036,'','',0,0 
end
