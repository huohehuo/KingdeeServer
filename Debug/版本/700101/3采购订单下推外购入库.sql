...
SELECT @FInterID,@FBillNo,'0',1,0,0,@value,1,0,@Fdate,@FSupplyID,@FCheckDate,@FFManagerID,@FSManagerID,@FBillerID,@FPOStyle,Null,Null,Null,Null,Null,Null,'',0,0,71,0,@FExplanation,@FDeptID,@FManagerID,@FEmpID,0,0,@FSettleDate,36680,0
